                ...
                display_response: function(data_from_server) {
                    ...
                    if (data_from_server.success.length) {
                        ...
                        generateDiv(
                            ...
                            getText(success_data.length, MESSAGE_GROUP.successfully_added),
                            success_data
                        );
                    }
                    ...
                    if (Object.keys(data_from_server.row_errors).length) {
                        ...
                        if (row_errors.data_format_error.length) {
                            ...
                            generateDiv(
                                ...
                                getText(format_errors.length, MESSAGE_GROUP.data_format_error),
                                format_errors
                            );
                        }
                        if (row_errors.user_not_exist.length) {
                            ...
                            generateDiv(
                                ...
                                getText(user_not_exist.length, MESSAGE_GROUP.user_not_exist),
                                user_not_exist
                            );
                        }
                        if (row_errors.user_already_white_listed.length) {
                            ...
                            generateDiv(
                                ...
                                getText(user_already_white_listed.length, MESSAGE_GROUP.user_already_white_listed),
                        ...
                        if (row_errors.user_not_enrolled.length) {
                            ...
                            generateDiv(
                                ...
                                getText(user_not_enrolled.length, MESSAGE_GROUP.user_not_enrolled),
                                user_not_enrolled
                            );
                        }
